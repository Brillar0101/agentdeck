"""Cross-check the V4 PCB against v4/PARTS.yaml (the single source of truth).
...
Current/bin/python3 v4/tools/verify_parts.py [board.kicad_pcb]
...
DEFAULT_BOARD = ROOT / "hardware" / "ClaudeMicroV4.kicad_pcb"
TOL_MM = 0.5
