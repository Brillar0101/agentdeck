#!/usr/bin/env python3
"""Generate v3/hardware/ClaudeMicroV3.kicad_sch (and V3.kicad_sym) section by section.

ClaudeMicro V3 — hand-solderable 24-key AI control deck (ESP32-S3, OLED, LiPo).
...
'''
sch_path = os.path.join(HW, "ClaudeMicroV3.kicad_sch")
