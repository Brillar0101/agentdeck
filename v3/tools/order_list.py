"""Generate the LCSC/JLCPCB parts-order shopping list from v3/PARTS.yaml.

Outputs v3/fab/order-list.csv (LCSC cart import format: LCSC#, qty) plus a
...
Usage: python3 v3/tools/order_list.py [--boards N] [--allow-verify]
"""
import argparse
import csv
import math
