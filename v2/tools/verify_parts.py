"""Cross-check the V2 PCB against v2/PARTS.yaml (the single source of truth).
...
Current/bin/python3 v2/tools/verify_parts.py [board.kicad_pcb]
...
DEFAULT_BOARD = ROOT / "hardware" / "AgentDeckV2.kicad_pcb"
TOL_MM = 0.5
