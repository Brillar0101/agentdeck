"""Dress the V2 assembly: real fastener meshes + natural PBR materials + render.

Adds to v2/enclosure/AgentDeckV2-assembled.blend:
  ...
  * a lit camera + EEVEE preview render -> AgentDeckV2-preview.png

Run:  blender -b --python v2/tools/dress_assembly.py
"""
import json
import math
...
BLEND = ROOT + "v2/enclosure/AgentDeckV2-assembled.blend"
PREVIEW = ROOT + "v2/enclosure/AgentDeckV2-preview.png"
pos = json.load(open(ROOT + "v2/enclosure/positions.json"))
HOLES = [tuple(v) for _, v in sorted(pos["holes"].items())] if "holes" in pos \
    else [(6, 6), (144, 6), (6, 104), (144, 104), (6, 55), (144, 55)]

# case stack (make_case_v2.py)
