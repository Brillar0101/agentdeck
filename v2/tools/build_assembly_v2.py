"""Build the AgentDeck V2 assembly in Blender: board GLB + 24 switches with
caps + encoder knob + battery placeholder. The case is added by make_case_v2.py.

Pipeline (paths are arguments, nothing hardcoded):
  1. kicad python  v2/tools/export_positions_v2.py --pcb ... --out positions.json
  2. kicad-cli pcb export glb --subst-models --include-tracks --include-pads \
       ...
       -o AgentDeckV2.glb AgentDeckV2.kicad_pcb
  3. blender -b --python v2/tools/build_assembly_v2.py -- \
       --positions ... --glb ... --assets <repo enclosure dir> --blend <out.blend>
  4. blender -b --python v2/tools/make_case_v2.py -- ...
...
they are only identified and renamed here (V1 needed re-seating, V2 does not).
"""
import argparse
import json
import math
